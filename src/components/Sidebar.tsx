...
import { HiCreditCard, HiDeviceTablet, HiLogin, HiMenuAlt2, HiOutlineHome, HiUserGroup } from "react-icons/hi";
    ...
    <div className="relative">
      ...
      >
        ...
        <div>
          ...
          >
            <HiDeviceTablet className="text-xl" />
            <span className="text-lg">Today's Games</span>
          </NavLink>
          <NavLink
            to="/categories"
            className={(isActiveObj) =>
          ...
          >
            ...
            <span className="text-lg">Game History</span>
          </NavLink>
          <NavLink
            to="/orders"
            className={(isActiveObj) =>
          ...
          >
            ...
            <span className="text-lg">Today's Players</span>
          </NavLink>
          <NavLink
            to="/users"
            className={(isActiveObj) =>
