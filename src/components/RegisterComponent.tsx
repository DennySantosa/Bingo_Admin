...
const RegisterComponent = () => {
  ...
  return (
    <div className="w-[500px] h-[600px] dark:bg-gray-900 bg-white flex flex-col justify-between items-center py-10 max-sm:w-[400px] max-[420px]:w-[320px] max-sm:h-[750px]">
