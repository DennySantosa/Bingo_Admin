            ...
            <div>
              ...
              <div className="mt-4 flex flex-col gap-5">
                <InputWithLabel label="Title">
                  <SimpleInput
                    type="text"
                    placeholder="Enter a TodayGame title..."
                ...
                <InputWithLabel label="Description">
                  <TextAreaInput
                    placeholder="Enter a TodayGame description..."
                    rows={4}
                    cols={50}
              ...
              <div className="mt-4 flex flex-col gap-5">
                <div className="grid grid-cols-2 gap-x-5 max-[500px]:grid-cols-1 max-[500px]:gap-x-0 max-[500px]:gap-y-5">
                  <InputWithLabel label="Base pricing">
                    <SimpleInput
                      type="text"
                      placeholder="Enter a TodayGame base pricing..."
                ...
                <div className="grid grid-cols-2 gap-x-5 max-[500px]:grid-cols-1 max-[500px]:gap-x-0 max-[500px]:gap-y-5">
                  <InputWithLabel label="Stock">
                    <SimpleInput
                      type="text"
                      placeholder="Enter a TodayGame stock..."
                  ...
                  <InputWithLabel label="SKU">
                    <SimpleInput
                      type="text"
                      placeholder="Enter a TodayGame SKU..."
              ...
              <div className="mt-4 flex flex-col gap-5">
                <div className="grid grid-cols-2 gap-x-5 gap-y-5 max-[500px]:grid-cols-1 max-[500px]:gap-x-0 max-[500px]:gap-y-5">
                  <InputWithLabel label="Weight (kg)">
                    <SimpleInput
                      type="text"
                      placeholder="Enter a TodayGame weight..."
                  ...
                  <InputWithLabel label="Length (cm)">
                    <SimpleInput
                      type="text"
                      placeholder="Enter a TodayGame length..."
                  ...
                  <InputWithLabel label="Width (cm)">
                    <SimpleInput
                      type="text"
                      placeholder="Enter a TodayGame width..."
                  ...
                  <InputWithLabel label="Height (cm)">
                    <SimpleInput
                      type="text"
                      placeholder="Enter a TodayGame height..."
