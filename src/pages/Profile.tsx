          ...
          <div className="px-4 sm:px-6 lg:px-8 pb-8 pt-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex justify-between items-center max-sm:flex-col max-sm:gap-10">
                ...
                <button className="w-72 py-2 text-lg rounded-lg shadow-md transition-all duration-300 
                  bg-whiteSecondary dark:bg-blackPrimary border border-gray-600 
                  hover:bg-gray-100 dark:hover:bg-gray-800 
                  dark:hover:border-gray-500 hover:border-gray-400 
                  flex items-center justify-center gap-x-2 
                  font-medium text-blackPrimary dark:text-whiteSecondary 
