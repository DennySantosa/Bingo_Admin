              ...
              <div>
                <div className="mt-4 flex flex-col gap-5">
                  <InputWithLabel label="Search TodayGames">
                    <SimpleInput type="text" placeholder="Search TodayGames..." value={inputObject.searchTodayGames} onChange={(e) => setInputObject({ ...inputObject, searchTodayGames: e.target.value })} />
                  </InputWithLabel>
                  ...
                  <div className="mt-4 flex flex-col gap-5 max-[450px]:items-start">
                    <div className="flex justify-between items-center max-[450px]:flex-col">
                      <div className="flex items-center gap-3 max-[450px]:flex-col">
                        <img src="/src/assets/tablet (1).jpg" alt="TodayGame" className="w-12 h-12" />
                    ...
                    <div className="flex justify-between items-center max-[450px]:flex-col">
                      <div className="flex items-center gap-3  max-[450px]:flex-col">
                        <img src="/src/assets/tablet (2).jpg" alt="TodayGame" className="w-12 h-12" />
                    ...
                    <div className="flex justify-between items-center max-[450px]:flex-col">
                      <div className="flex items-center gap-3  max-[450px]:flex-col">
                        <img src="/src/assets/tablet (3).jpg" alt="TodayGame" className="w-12 h-12" />
