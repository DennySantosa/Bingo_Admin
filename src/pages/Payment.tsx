        ...
        <div className="dark:bg-blackPrimary bg-whiteSecondary py-10">
          <div className="px-4 sm:px-6 lg:px-8 flex justify-between items-center max-sm:flex-col max-sm:gap-5">
            ...
            <div className="flex gap-x-2 max-[370px]:flex-col max-[370px]:gap-2 max-[370px]:items-center">
              <button className="bg-pink-200 text-white font-semibold rounded-lg shadow-md w-32 h-12 flex items-center justify-center space-x-2 transition-colors duration-300 hover:bg-pink-400" onClick={ ()=> downloadCSV(userAdminItems, 'all_payments_data.csv')}>
