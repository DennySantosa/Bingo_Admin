...
const EditReview = () => {
  const [inputObject, setInputObject] = useState({
    TodayGame: "Samsung Galaxy S21 Ultra 5G",
    rating: 5,
          ...
          <div className="px-4 sm:px-6 lg:px-8 pb-8 border-b border-gray-800 flex justify-between items-center max-sm:flex-col max-sm:gap-5">
            ...
            <div className="flex gap-x-2 max-[370px]:flex-col max-[370px]:gap-2 max-[370px]:items-center">
              <button className="bg-gradient-to-r from-gray-200 to-gray-300 border border-gray-400 rounded-lg w-48 py-2 text-lg font-medium text-gray-800 flex items-center justify-center gap-2 transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:border-gray-500">
                ...
                <span className="text-gray-800">Save review</span>
              </button>
              <WhiteButton
                link="/reviews"
                textSize="lg"
          ...
          <div className="px-4 sm:px-6 lg:px-8 pb-8 pt-8 grid grid-cols-2 gap-x-10 max-xl:grid-cols-1 max-xl:gap-y-10">
            ...
            <div>
              ...
              <div className="mt-4 flex flex-col gap-5">
                <InputWithLabel label="TodayGame to rate">
                  <SimpleInput
                    type="text"
                    placeholder="Search a TodayGame to rate..."
                    value={inputObject.TodayGame}
                    onChange={(e) =>
                      setInputObject({
                        ...inputObject,
                        TodayGame: e.target.value,
                      })
                    }
                  />
                </InputWithLabel>
